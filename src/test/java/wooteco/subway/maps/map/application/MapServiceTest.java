...
public class MapServiceTest {
    ...
    void setUp() {
        ...
        Line line1 = TestObjectUtils.createLine(1L, "2호선", "GREEN", 100);
        ...
        Line line2 = TestObjectUtils.createLine(2L, "신분당선", "RED", 200);
        line2.addLineStation(new LineStation(2L, null, 0, 0));
        line2.addLineStation(new LineStation(3L, 2L, 2, 1));

        Line line3 = TestObjectUtils.createLine(3L, "3호선", "ORANGE", 300);
